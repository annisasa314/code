...
def proses_video(model, video_path, output_path, speed_label):
    ...
    try:
        while cap.isOpened():
            ...
            cv.imshow("YOLO12 Detection + ROI", frame)
...
def main():
    ...
    model_path = "/home/aimp/Documents/icha/models/yolo12n_HT.engine"
    ...
    daftar_video = [
        {
            ...
            "output": "yolo12_fp16_speed-0.2ms.mp4",
        },
        {
            "speed": "0.6 m/s",
            "input": "/home/aimp/Documents/icha/videos/video_0.6.mp4",
            "output": "yolo12_fp16_speed-0.6ms.mp4",
        },
        {
            "speed": "1.0 m/s",
            "input": "/home/aimp/Documents/icha/videos/video_1.0.mp4",
            "output": "yolo12_fp16_speed-1.0ms.mp4",
        },
    ]
